...
const uploadImage = (e) => {
  ...
  fetch('https://localhost:5000/util/uploadfile', {
    method: 'POST',
    body: fd,
  })
    .then(res => {
    ...
    const updateProfile = (data) => {
      fetch(`htttp://localhost:5000/user/update/${currentUser._id}`, {
        method: 'PUT',
                  ...
                  <div className="flex flex-wrap justify-center">
                    <div className="w-full lg:w-3/12 px-4 lg:order-2 flex justify-center">
                      <div className="relative">
                        <img
                          alt="..."
                          src={currentUser.avatar && `http://localhost:5000/uploads/${currentUser.avatar}`}
