...
const Signup = () => {
  ...
  return (
    <div >
      <main className="w-full max-w-md mx-auto p-11 ">
        <div className="mt-10 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700 ">
          <div className="p-20 sm:p-7 ">
