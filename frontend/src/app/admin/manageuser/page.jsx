                 ...
                 {obj.name}
                    ...
                    <td className="px-4 py-3 flex items-center justify-end">
                      ...
                      >
                        ...
                        <div className="py-1">
                          <button
                          onClick = {() => { deletefunc(obj._id)}}
                            href="#"
                            className="block py-2 px-4 text-sm text-black hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white"
                          >
                            Delete
                          </button>
                        </div>
